...
angular.module('app').factory('microphone', function () {
...
var Microphone = {
    ...
    _exportDataBufferTo16Khz: function(bufferNewSamples) {
        var buffer = null,
    ...
    _exportDataBuffer: function(buffer) {
    ...
    encodeWav: function(samples, numChannels, sampleRate) {
